...
* **release:** update documentation ([5ca9deb](https://github.com/StarOfService/kitsu/tree/master/packages/kitsu-core/commit/5ca9deb))


### New Features

* skip nulls, fix booleans ([ab33067](https://github.com/StarOfService/kitsu/tree/master/packages/kitsu-core/commit/ab33067))
