...
* **release:** update documentation ([63fe8bb](https://github.com/StarOfService/kitsu/tree/master/packages/kitsu/commit/63fe8bb))


### New Features

* add typings for sort object param ([047c8e1](https://github.com/StarOfService/kitsu/tree/master/packages/kitsu/commit/047c8e1))





# [7.3.0](https://github.com/StarOfService/kitsu/tree/master/packages/kitsu/compare/v7.2.0...v7.3.0) (2019-11-04)


### Chores

* **release:** update documentation ([7b2d389](https://github.com/StarOfService/kitsu/tree/master/packages/kitsu/commit/7b2d389))
